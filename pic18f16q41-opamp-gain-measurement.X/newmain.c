...
// * Author: C62081
// *
// * Created on February 26, 2020, 8:57 AM
// */
//
//// CONFIG1
...
//#include "OPAconfig.h"
//
////Wakes the core from Sleep when ADC is done
//void __interrupt(irq(ADT)) sleepISR()
//{
//    PIR2bits.ADTIF = 0;
//}
//
//void main(void) {
//    
//    initADCC();     //Enable the ADCC
//    initOPA();
//    initUART();     //9600 BAUD UART
//    initTMR2();     //10s re-cal request
//    
//    initIO();
//    
//    //Always interrupt on threshold
//    ADCON3bits.TMD = 0b111;
//    
//    //Enable ADCT Interrupt
//    PIR2bits.ADTIF = 0;
//    PIE2bits.ADTIE = 1;
//    
